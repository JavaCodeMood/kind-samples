package com.kind.samples.core.jvm.memory;
...
public class MyStringConstant {
    ...
    public static void main(String[] args) {
        new MyStringConstant().testString1();
        new MyStringConstant().testString2();
        new MyStringConstant().testString3();
        new MyStringConstant().testString4();
    }
}
